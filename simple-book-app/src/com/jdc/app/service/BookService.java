...
public class BookService {
	...
	private static final String sqlSearch = "select b.id, b.name book_name, b.price price, b.released_date released_date,"
			+ " b.remark remark, c.id category_id, c.name category_name, a.id author_id,  a.name author_name from book b join category c on b.category_id = c.id"
